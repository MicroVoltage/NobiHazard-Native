...
[RequireComponent(typeof(GenericAnimatorManager))]
public class ZombieController : MonoBehaviour {
	...
	GenericAnimatorManager genericAnimatorManager;
	...
	void Start () {
		genericAnimatorManager = GetComponent<GenericAnimatorManager>();
	...
	void FixedUpdate () {
		...
		if (wondering && Time.time > lastWonderTime + wonderInterval) {
			...
			wantedPosition = GameController.characterManager.heroInstance.transform.position;
		}
